...
function retrieveSavedTaskLists() {
    ...
    for (const taskListKey in savedTaskLists) {
        for (const task in savedTaskLists[taskListKey]) {
            ...
            console.log(_Project__WEBPACK_IMPORTED_MODULE_1__.ProjectList.getList()[i])
...
const ProjectBoard = (() => {
    ...
    const selectProjectBoardCurrentProject = ()=> {
        console.log(_functionnalities_Project__WEBPACK_IMPORTED_MODULE_0__.ProjectList.currentProject)
...
if (_functionnalities_localStorage__WEBPACK_IMPORTED_MODULE_8__.isLocalStorageEmpty) {
