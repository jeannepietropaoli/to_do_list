   ...
   /*  ProjectBoard.deleteDefaultProject(); */
    ...
    for (const projectKey in localStoragedProjects) {
        if (i>0) {
            ...
            _functionnalities_Project__WEBPACK_IMPORTED_MODULE_0__.ProjectList.addProject(localStoragedProjects[projectKey])
        }
        i++;
    }
})
